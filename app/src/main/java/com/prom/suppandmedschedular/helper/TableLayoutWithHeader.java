...
public class TableLayoutWithHeader extends LinearLayout
{
	public TableLayoutWithHeader( Context context )
	{
		super( context );
	}
	
	public TableLayoutWithHeader( Context context, AttributeSet attrs )
	{
		super( context, attrs );
	}
